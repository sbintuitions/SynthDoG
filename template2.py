...
class SynthDoG2(templates.Template):
    ...
    def generate(self):
        ...
        for text_layer in text_layers:
            quad = [[q[0], q[1]] for q in text_layer.quad]
            bounding_boxes.append(quad)
    ...
    def save(self, root, data, idx):
        ...
        bounding_boxes_str = [[[str(coord) for coord in corner] for corner in corners] for corners in bounding_boxes]
        ...
        metadata = self.format_metadata(image_filename=image_filename, keys=["text_sequence", "bounding_boxes"], values=[labels, bounding_boxes_str])
